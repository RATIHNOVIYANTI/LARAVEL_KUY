...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/1.jpg" class="card-img-top" alt="Foto Lulusan 1">
                    <div class="card-body">
                        <h5 class="card-title">RATIH NOViYANTI</h5>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/2.jpg" class="card-img-top" alt="Foto Lulusan 2">
                    <div class="card-body">
